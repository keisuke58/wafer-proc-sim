...
class TestTerafabProduction:
    from fem.terafab_model import production_target, yield_chain, capex_analysis

    def test_production_target_1TW(self):
        """1 TW → 少なくとも 1億枚以上のチップが必要。"""
        from fem.terafab_model import production_target
    ...
    def test_yield_chain_cumulative_monotone_decreasing(self):
        ...
        from fem.terafab_model import yield_chain
        chain = yield_chain()
    ...
    def test_capex_japan_share_reasonable(self):
        ...
        from fem.terafab_model import capex_analysis
        c = capex_analysis()
...
class TestTransmonQubit:
    def test_qubit_frequency_in_GHz_range(self):
        ...
        from fem.quantum_computing_model import transmon_qubit
...
class TestSurfaceCodeQEC:
    def test_below_threshold_returns_results(self):
        ...
        from fem.quantum_computing_model import surface_code_overhead
    ...
    def test_wafer_integration_qubit_count_positive(self):
        from fem.quantum_computing_model import si_qubit_wafer_integration
...
class TestHyperscalerModel:
    def test_tesla_ai5_highest_efficiency(self):
        ...
        from fem.hyperscaler_model import ASIC_SPECS
        efficiencies = {
    ...
    def test_tco_advantage_custom_asic_positive(self):
        ...
        from fem.hyperscaler_model import tco_analysis
    ...
    def test_wafer_demand_positive(self):
        ...
        from fem.hyperscaler_model import HYPERSCALER_CAPEX, wafer_demand
    ...
    def test_tesla_fsd_chip_demand_millions(self):
        ...
        from fem.hyperscaler_model import tesla_fsd_inference_demand
    ...
    def test_nvidia_share_decreasing_over_time(self):
        ...
        from fem.hyperscaler_model import NVIDIA_SHARE
    ...
    def test_total_hyperscaler_capex_above_400B(self):
        ...
        from fem.hyperscaler_model import HYPERSCALER_CAPEX
